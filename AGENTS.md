...
- **Skill (start here):** [`leonxstream/skill/SKILL.md`](leonxstream/skill/SKILL.md) — attribute grammar, effect verbs, expression whitelist, gotchas.
- **Naming rulebook:** [`leonxstream/naming.md`](leonxstream/naming.md) — how the grammar names things and how it may grow; read before proposing new attributes or verbs. It is also installed at `.zcode/skills/leonxstream/SKILL.md` for tool discovery; a drift test (`tests/skill.test.ts`) keeps the two identical.
