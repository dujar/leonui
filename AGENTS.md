...
- **Dev loop:** `bun run dev` (pages + mock API on :4700) · `bun run build` · `bun run typecheck` · `bun test tests/` (60 tests over real Chromium) · `bun run bench` (regenerates `benchmark.md`).
