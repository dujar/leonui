...
inherit HTML's silent-attribute behavior, but leonui's stated differentiator
...
1. **B1 remainder — fixed.** skill/SKILL.md:8 now reads "a small attribute grammar (five families plus satellites)" and line 10 "## The attribute families" — no "four attribute families" remains; the workspace copy (.zcode/skills/leonui/SKILL.md) is byte-identical. naming.md and SKILL.md now agree on five families.
