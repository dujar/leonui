...
t('naming: unknown verbs and unknown ui:* attributes are named warnings, not no-ops', async () => {
  ...
  await p.eval(`import('/dist/leonui.js').then(m => m.attach(document.getElementById('typo-verb')))`);
  ...
  await p.eval(`import('/dist/leonui.js').then(m => m.attach(document.getElementById('typo-attr')))`);
  assert.ok(
...
t('naming: attr: aspect works in the variant form', async () => {
  ...
  await p.eval(`import('/dist/leonui.js').then(m => m.attach(document.querySelector('#attr-variant')))`);
...
t('naming: attr: aspect works in the list form', async () => {
  ...
  await p.eval(`import('/dist/leonui.js').then(m => m.attach(document.body.lastElementChild))`);
...
t('naming: onsuccess gates on success, onfail on failure — same list', async () => {
  ...
  await p.eval(`import('/dist/leonui.js').then(m => m.attach(document.getElementById('post-ok'))).then(() => import('/dist/leonui.js')).then(m => m.attach(document.getElementById('post-bad')))`);
